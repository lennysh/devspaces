...
1. Create a local virtual environment for devspaces (suggested, it's your system!)
2. Use pip to install pre-commit in your environment of choice: `pip install pre-commit`
3. Install pre-commit hooks with `pre-commit install --install-hooks`
...
6. [Optional] Run pre-commit checks at any time with `pre-commit run --all`
